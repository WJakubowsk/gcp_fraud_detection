...
csv_file_path = "transactions/txs_features_engineered.csv"
...
for col in ['in_txs_degree', 'out_txs_degree', 'num_input_addresses', 'num_output_addresses']:
...
for batch_num in tqdm(range(num_batches)):
    ...
    for index in range(start_index, end_index):
        ...
        # print(row['Aggregate_feature_1'])
        # print(type(row['Aggregate_feature_1']))
